...
from database import get_user_attr, set_user_attr
...
def register_handlers(bot):
    ...
    def handle_tiktok_link(message):
        ...
        if current_time < expiry_time:
            send_quality_options(bot, message.chat.id, get_user_attr(u_id, "lang", "en"))
            return
    ...
    def send_quality_options(bot_instance, chat_id, lang):
        if lang == "am":
        ...
        bot_instance.send_message(chat_id, prompt_text, reply_markup=markup)
